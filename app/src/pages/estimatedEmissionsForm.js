...
import {UpsertEstimatedEmission} from '../services/service'
import './pages.css'


const EstimatedEmissionsForm = ({setDataDidUpdate}) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {   
      const response = await UpsertEstimatedEmission(formData)
        setFormData({
          site: '',
          latitude: '',
          longitude: '',
  ...
  return (
    <div>
      <h2>Add an Estimated Emission</h2>
...
export default EstimatedEmissionsForm;
